...
class Location private constructor(val uri: Uri, val path: Path) {
    ...
    fun open(context: Context): OpenedLocation? {
        ...
        return OpenedLocation(uri, path)
    }
    ...
    companion object {
        fun from(context: Context, uri: Uri): Location? {
