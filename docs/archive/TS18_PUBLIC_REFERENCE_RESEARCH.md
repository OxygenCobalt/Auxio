# TS18 Public Reference Research (archived pointer)

> Status: archived/superseded.
>
> This file is intentionally redirect-only. Active policy and source corpus are maintained in `docs/TS18_SOURCE_LED_INTEGRATION_STRATEGY.md`.
