...
Failure classes:
`OK`, `WARN_OPTIONAL_TOOL_MISSING`, `SNAPSHOT_LIMITATION`, `SUBMODULE_BLOCKER`, `UPSTREAM_MEDIA_QUIRK`, `ANDROID_SDK_BLOCKER`, `ANDROID_NDK_BLOCKER`, `JAVA_GRADLE_COMPAT_BLOCKER`, `DEPENDENCY_CACHE_BLOCKER`, `CODEX_AGENT_OFFLINE_LIMITATION`, `REAL_BUILD_FAILURE`, `HARDWARE_ONLY_VALIDATION`.
